        ...
        <div class="container">
          <div class="row">
              ...
              <div id="star" class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                    <li class="nav-item">
                     <a href="../jobs.php"><i class="fa fa-user"></i>Active Job Positions</a>
                    </li>
            ...
            <div class="col-md-9 bg-white padding-2">
              ...
              <?php
              $sql = "SELECT COUNT(*) as count from apply_job_post";
              ...
              // Display result
              echo "Number of Candidates applied for placement : " . $count;
              ?>
