              ...
              <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                    <li><a href="../jobs.php"><i class="fa fa-user"></i>Active Job Positions</a></li>
                    ...
                    <li><a href="../ML.php"><i class="fa fa-address-card"></i>Prediction</a>
                ...
                ?>
                    <div class="row">
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" class="form-control input-lg" id="fname" name="fname" placeholder="Enrollment No" value="<?php echo $row['enroll']; ?>" required="">
                        </div>
                        <div class="form-group">
                      ...
                      <div class="col-md-6 latest-job ">
                        ...
                        <div class="form-group">
                          <label for="Marks">UG Percentage</label>
