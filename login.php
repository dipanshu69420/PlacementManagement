    ...
    <section class="text-gray-600 body-font">
        <div class="container px-5 py-24">
            <div class="flex flex-wrap -m-4">
                ...
                <div class="p-4 md:w-1/2 ">
                    <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden align-items-center">
                        ...
                        <div class="p-6">
                            ...
                            <p class="leading-relaxed mb-3">The company recruiters can log into their account from here.</p>
                            <div class="flex items-center flex-wrap">
