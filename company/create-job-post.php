...
<head>
  ...
  <title>PMS | Create Job Post</title>
              ...
              <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                    ...
                    <li><a href="my-job-post.php"><i class="fa fa-file-o"></i> Current Jobs</a></li>
                    <li><a href="job-applications.php"><i class="fa fa-file-o"></i> Job Applications</a></li>
                    <li class="active"><a href="create-job-post.php"><i class="fa fa-file-o"></i> Post Job</a></li>
