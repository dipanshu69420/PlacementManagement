...
<head>
  ...
  <title>PMS | Candidate Register</title>
  ...
  <div class="wrapper">
          ...
          <div class="row latest-job margin-top-50 margin-bottom-20 bg-white">
            ...
            <form method="post" id="registerCandidates" action="adduser.php" enctype="multipart/form-data">
              ...
              <div class="form-group">
                  <input class="form-control input-lg" type="text" id="enroll" name="enroll" placeholder="Enrollment No *" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control input-lg" type="date" id="dob" max="31/12/2003" name="dob" placeholder="Date Of Birth">
                </div>
                <div class="form-group">
    ...
    <footer class="main-footer" style="margin-left: 0px;">
      <div class="text-center">
        <strong>Made By : Team The Errors</strong>
      </div>
    </footer>
