              ...
              <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                    <<li class="active"><a href="user/edit-profile.php"><i class="fa fa-user"></i> Active Job Positions</a></li>
                    
                    
                    <li><a href="user/update.php"><i class="fa fa-address-card-o"></i> My Applications</a></li>
